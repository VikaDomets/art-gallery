...
const Exhibitions = () => {
  ...
  // Скидаємо сторінку при зміні даних (з контексту)
  useEffect(() => {
    setCurrentPage(1);
  }, [exhibitions]);
  ...
  return (
    <section className={styles.exhibition}>
      <div className={styles['exhibition-section']}>
        ...
        {/* Додано key={currentPage} для анімації при зміні сторінки */}
        <div 
          className={`${styles['exhibitions-list']} ${styles.fadeIn}`} 
          key={currentPage}
        >
          ...
          <div className={styles['pagination-container']}>
            <nav aria-label="Навігація по сторінкам">
              <ul className={styles.pagination}>
                {/* Кнопка "Попередня" */}
                <li className={`${styles['page-item']} ${currentPage === 1 ? styles.disabled : ''}`}>
                  <button
